...
Use this runbook to install, pair, operate, upgrade, and revoke the internal Android Operator Command Center. Release `2.0.0` uses Android package `com.cryptoarc.cockpit` and `versionCode` `3`.
