...
class BotState:
    ...
    def source_health(self) -> dict[str, object]:
        ...
        return {
            ...
            "trade_reconnect_attempts": self.source_status.trade_reconnect_attempts,
            "reconnect_events": self.source_status.reconnect_events,
            "trade_reconnect_events": self.source_status.trade_reconnect_events,
            "last_disconnect_at": self.source_status.last_disconnect_at.isoformat() if self.source_status.last_disconnect_at else None,
            "last_recovered_at": self.source_status.last_recovered_at.isoformat() if self.source_status.last_recovered_at else None,
            "last_disconnect_stream": self.source_status.last_disconnect_stream or None,
            "last_recovered_stream": self.source_status.last_recovered_stream or None,
            "health_score": max(0, min(100, health)),
            "status_message": status_message,
